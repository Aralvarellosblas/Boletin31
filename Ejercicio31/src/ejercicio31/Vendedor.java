...
public class Vendedor extends Empregado{
    ...
    public XefeZona getXefez(){
        return xefez;
    }

    public void setXefez(XefeZona xefez){
        this.xefez=xefez;
    }
    ...
    public String toString(){
        return "Vendedor: coche="+coche+", telfMovil "+telfMovil+", area "+area+", xefe "+xefez+", lcl "+lcl;
    }
}
